...
OFFICIAL_CONTACT = "+91-9380486921"
...
- Show one-sentence empathy.
- Provide up to 3 clear steps and recommend one best option.
...
# ---- BOT MANAGEMENT ----
def create_bot_record(start_url: str, name: str | None = None):
...
def create_bot():
    ...
    bot_doc = create_bot_record(start_url, name)
...
def chat():
    ...
    if low_confidence:
        ...
        contact_msg = (
            ...
            f"For official help, please contact the owner at {OFFICIAL_CONTACT}."
            " They can provide authoritative assistance."
        )
        if normalized_answer.startswith("I don't know based on the provided information.") or normalized_answer.startswith("I don't have an answer"):
            answer = (
                "I don't know based on the provided information."
                + " If you need an authoritative answer, please contact the owner at "
                f"{OFFICIAL_CONTACT}."
            )
        else:
